...
\section{Problem 5}
    ...
    \subsection{Solution (b)}
        ...
        \begin{proof}[Proof by Construction]
            ...
            This means $K$ is compact.
            Ergo, a set $K \subset (X, d)$ is compact if every cover of $K$ consisting of open balls has a finite subcover.
        \end{proof}
        ...
        Last, we consolidate it.
        \begin{proof}
            We know that if $K \subset (X,d)$ is compact, then every cover of $K$ consisting of open balls has a finite subcover.
            We also know that if every cover of $K \subset (X,d)$ consisting of open balls has a finite subcover, then the set $K$ is compact.
            Ergo, a set $K \subset (X, d)$ is compact if and only if every cover of $K$ consisting of open balls has a finite subcover.
        \end{proof}
