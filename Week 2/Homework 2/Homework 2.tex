...
\section{Problem 2}
    ...
    \subsection{Solution (e)}
        ...
        \begin{proof}
            Look at the difference between $B_r(x)$ and $D_r(x)$.
            The difference is the cases where $d(y, x) = r$.
        \end{proof}
...
\section{Problem 3}
    ...
    \subsection{Solution (a)}
        ...
        The function is $d$.
        We need to prove that the distance function satisfies three conditions:
        \begin{enumerate}[label=(\alph*)]
            \item   $d(p,q) > 0$ if $p \neq q$; $d(p,q) = 0$ if $p = q$
            \item   $d(p,q) = d(q,p)$
