...
\section{Problem 2}
    ...
    \subsection{Solution (a)}
        ...
        \begin{proof}
            ...
            Take the square root of both sides to find that $\sqrt{n} \leq \sqrt{m}$\footnote{Cite a source.}.
        ...
        \begin{proof}
            ...
            Take the square root of both sides to find that $\sqrt{n} < \sqrt{n + 1}$\footnote{Cite a source.}.
