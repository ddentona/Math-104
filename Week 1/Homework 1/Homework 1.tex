...
\section{Exercise 3}
    ...
    \subsection{Solution (b)}
    \begin{proof}
        We start by proving that for all $a, b,$ and $c$ in $\mathbb{Q}$ with $a \preceq b$, we have $a + c \preceq b + c$.
        That is to say, for all $a, b,$ and $c$ in $\mathbb{Q}$ with $a \geq b$, we have $a + c \geq b + c$.
        As in the textbook, let us define $r < s$ in $\mathbb{Q}$ to mean that $r - s$ is a positive rational number.
    \end{proof}
